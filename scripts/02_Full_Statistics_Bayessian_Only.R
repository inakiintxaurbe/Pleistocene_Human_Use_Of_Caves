...
saveWorkbook(
  wb,
  file.path(output_dir, "evidences_Tests_Bayesian_Only.xlsx"),
  overwrite = TRUE
)
...
### Omited because there is only 1 dimension with only two regions ... ###
### ... with accepted dated sites (Eastern Europe and Western Europe). ###
### In the future this part should be added again, once new dated  ... ###
### ... sites are added. #################################################
